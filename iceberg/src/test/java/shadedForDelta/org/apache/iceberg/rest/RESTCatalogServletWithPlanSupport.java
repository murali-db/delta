 ...
 */
public class RESTCatalogServletWithPlanSupport extends RESTCatalogServlet {

  private final RESTCatalogAdapter adapter;
  private final ObjectMapper mapper;

  public RESTCatalogServletWithPlanSupport(RESTCatalogAdapter adapter) {
    super(adapter);
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse resp)
    ...
    if (path != null && path.endsWith("/plan")) {
      System.out.println("Custom servlet handling /plan request for path: " + path);
  ...
  private void handlePlanRequest(HttpServletRequest req, HttpServletResponse resp)
    ...
    try {
      ...
      System.out.println("Plan request - path: " + path);
      System.out.println("Plan request - body: " + body);
      ...
      System.err.println("Error handling /plan request: " + e.getMessage());
      e.printStackTrace();
      resp.setStatus(500);
